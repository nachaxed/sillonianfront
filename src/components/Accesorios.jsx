         ...
         <div className="latest">
           <div className="latestDiv">
            <div className="latestTexts">
              <h3 className="latestTitle">Accesorios</h3>
              <p className="latestdesc">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque minima molestias magnam.</p>
            </div> 
              ...
              <div className="latestDivContent">
                <Slider {...settings}>
                  <div className='sliderImgDiv'>
                    <div className="sliderImgTop">
                      <div className="sliderImgTopInner">
                        <img src="./assets/uploads/sillon2.jpg" alt="" className="sliderImage" />
                      </div>
                  ...
                  <div className='sliderImgDiv'>
                    <div className="sliderImgTop">
                      <div className="sliderImgTopInner">
                        <img src="./assets/uploads/sillon1.jpg" alt="" className="sliderImage" />
                      </div>
                      <div className="sliderImgTopHover">
                  ...
                  <div className='sliderImgDiv'>
                    <div className="sliderImgTop">
                      <div className="sliderImgTopInner">
                        <img src="./assets/uploads/sillon3.jpg" alt="" className="sliderImage" />
                      </div>
                      <div className="sliderImgTopHover">
                        <Link to='/' className="sliderImgLink">
                          <FaEye />
